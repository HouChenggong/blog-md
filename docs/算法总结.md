...
[补码相关原理](https://blog.csdn.net/zhuozuozhi/article/details/80896838)
...
[非常清楚的题解](https://leetcode-cn.com/problems/n-queens/solution/nhuang-hou-jing-dian-hui-su-suan-fa-tu-wen-xiang-j/)

[一个解答思路](https://leetcode-cn.com/problems/n-queens/solution/n-huang-hou-hui-su-suan-fa-yao-pan-duan-s59q0/)
...
注意代码： int oneMax=oneHeight*(i-stack.peekLast()-1);求宽度的时候需要从栈中再拿一次
