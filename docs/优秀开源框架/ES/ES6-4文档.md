...
#### 3.6.8 simple_query_string

https://elasticsearch.cn/question/9991
...
区别是：两个多能做到平滑升级，但是用别名的方式多了一个创建别名的开销，如果不是必须有别名想要的功能，其实也不太建议用别名
...
一般关于自定义分词等配置都可以参考下面的方案：

[基于Mysql热更新词库](https://blog.csdn.net/qq_20919883/article/details/110502496)

[热更新词库的三种方式](https://blog.csdn.net/qq_40592041/article/details/107856588)

[官网stop-token-filter设置](https://www.elastic.co/guide/en/elasticsearch/reference/6.4/analysis-stop-tokenfilter.html)



但是关于停用词，其实也可以通过在索引层面解决，比如一个索引的设置如下ES 滚动升级重启

[ES滚动重启](https://www.jianshu.com/p/e070c632fb7b?utm_campaign=haruki)
